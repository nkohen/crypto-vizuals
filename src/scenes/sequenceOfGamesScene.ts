...
//
// One layer per diagram. The argument keeps drawing rows of keystream blocks —
// in the chain, in G₀, in Gᵢ, in Gₜ — that look alike but are different pictures
// with different positions and colours, so each gets its own layer and its own
// ids. Note the ladder is visited twice: step 3 climbs it and step 8 returns to
// sum it, which needs only the extra `lad-sum` arrow, not a second diagram.

import { buildScene } from './authoring';

const ADV = '\\mathsf{Adv}_{\\mathrm{prg}}';

export const sequenceOfGamesScene = buildScene({
  id: 'sequence-of-games',
  title: 'Sequential Stream Cipher Security by a Sequence of Games',
  tabLabel: 'Sequence of Games',
  subtitle: 'A hybrid argument: walking from the real keystream to a one-time pad, one PRG call at a time.',
  theorem:
  ...
  layers: [
    // ── the construction ─────────────────────────────────────────────────────
    {
      ...
      entities: [
        ...
        { id: 'chain-g1', kind: 'box', role: 'internal', x: 140, y: 214, w: 96, h: 84, label: 'G' },
        { id: 'chain-g2', kind: 'box', role: 'internal', x: 360, y: 214, w: 96, h: 84, label: 'G' },
        { id: 'chain-g3', kind: 'box', role: 'internal', x: 580, y: 214, w: 96, h: 84, label: 'G' },
        { id: 'chain-more', kind: 'value', role: 'internal', x: 744, y: 228, w: 56, h: 56, label: '⋯' },
        { id: 'chain-y1', kind: 'value', role: 'output', x: 154, y: 60, w: 68, h: 68, label: '$y_1$', caption: 'block' },
        { id: 'chain-y2', kind: 'value', role: 'output', x: 374, y: 60, w: 68, h: 68, label: '$y_2$' },
        { id: 'chain-y3', kind: 'value', role: 'output', x: 594, y: 60, w: 68, h: 68, label: '$y_3$' },
      ],
      arrows: [
        { id: 'chain-seed', from: 'val-s0', to: 'chain-g1', label: '$s_0 = k$', flow: true },
        { id: 'chain-out1', from: 'chain-g1', to: 'chain-y1', label: '$y_1$', flow: true },
        { id: 'chain-s1', from: 'chain-g1', to: 'chain-g2', label: '$s_1$', flow: true },
        { id: 'chain-out2', from: 'chain-g2', to: 'chain-y2', label: '$y_2$', flow: true },
        { id: 'chain-s2', from: 'chain-g2', to: 'chain-g3', label: '$s_2$', flow: true },
        { id: 'chain-out3', from: 'chain-g3', to: 'chain-y3', label: '$y_3$', flow: true },
        { id: 'chain-s3', from: 'chain-g3', to: 'chain-more', label: '$s_3$', flow: true },
      ],
    },
    ...
    // ── what security means ──────────────────────────────────────────────────
    {
      ...
      entities: [
        ...
        },
        {
          ...
          h: 150,
          label: 'Ideal world',
          caption: '$y_i \\xleftarrow{\\$} \\{0,1\\}^n$',
        },
      ],
      arrows: [
        { id: 'worlds-real', from: 'real', to: 'dist', label: 'keystream', flow: true },
        { id: 'worlds-ideal', from: 'ideal', to: 'dist', label: 'keystream', flow: true },
      ],
    },

    // ── the ladder, visited by steps 3 and 8 ─────────────────────────────────
    {
      id: 'l-ladder',
      name: 'The ladder',
      entities: [
        { id: 'lad-g0', kind: 'box', role: 'internal', x: 16, y: 250, w: 118, h: 92, label: 'G₀', caption: 'all real' },
        {
          id: 'lad-g1',
          kind: 'box',
          role: 'internal',
        ...
        { id: 'lad-gdots', kind: 'value', role: 'internal', x: 543, y: 264, w: 64, h: 64, label: '⋯' },
        { id: 'lad-gt', kind: 'box', role: 'input', x: 706, y: 250, w: 118, h: 92, label: 'Gₜ', caption: 'all random' },
      ],
      arrows: [
        { id: 'lad-h1', from: 'lad-g0', to: 'lad-g1', label: `$\\le ${ADV}$`, flow: true, curve: -56 },
        { id: 'lad-h2', from: 'lad-g1', to: 'lad-g2', label: `$\\le ${ADV}$`, flow: true, curve: -56 },
        { id: 'lad-h3', from: 'lad-g2', to: 'lad-gdots', label: `$\\le ${ADV}$`, flow: true, curve: -56 },
        { id: 'lad-h4', from: 'lad-gdots', to: 'lad-gt', label: `$\\le ${ADV}$`, flow: true, curve: -56 },
        // Only step 8 draws this one — the whole point of returning to the layer.
        { id: 'lad-sum', from: 'lad-g0', to: 'lad-gt', label: `$\\le t \\cdot ${ADV}$`, flow: true, curve: -150 },
      ],
    },
    ...
    // ── the real endpoint ────────────────────────────────────────────────────
    {
      ...
      name: 'Game G₀',
      entities: [
        { id: 'g0-banner', kind: 'box', role: 'internal', x: 300, y: 36, w: 280, h: 40, label: 'Game  G₀' },
        { id: 'g0-y1', kind: 'value', role: 'internal', x: 57, y: 112, w: 76, h: 76, label: '$y_1$' },
        { id: 'g0-y2', kind: 'value', role: 'internal', x: 187, y: 112, w: 76, h: 76, label: '$y_2$' },
        { id: 'g0-y3', kind: 'value', role: 'internal', x: 317, y: 112, w: 76, h: 76, label: '$y_3$' },
        { id: 'g0-y4', kind: 'value', role: 'internal', x: 447, y: 112, w: 76, h: 76, label: '$y_4$' },
        { id: 'g0-ydots', kind: 'value', role: 'internal', x: 577, y: 112, w: 76, h: 76, label: '⋯' },
        { id: 'g0-yt', kind: 'value', role: 'internal', x: 707, y: 112, w: 76, h: 76, label: '$y_t$' },
      ],
    },
    ...
    // ── a general hybrid ─────────────────────────────────────────────────────
    {
      ...
      name: 'Game Gᵢ',
      entities: [
        { id: 'gi-banner', kind: 'box', role: 'input', x: 300, y: 36, w: 280, h: 40, label: 'Game  Gᵢ' },
        { id: 'gi-y1', kind: 'value', role: 'input', x: 45, y: 135, w: 70, h: 70, label: '$y_1$' },
        { id: 'gi-ydots1', kind: 'value', role: 'input', x: 155, y: 135, w: 70, h: 70, label: '⋯' },
        { id: 'gi-yi', kind: 'value', role: 'input', x: 265, y: 135, w: 70, h: 70, label: '$y_i$' },
        { id: 'gi-shat', kind: 'value', role: 'input', x: 372, y: 132, w: 76, h: 76, label: '$\\hat s_i$' },
        { id: 'gi-yi1', kind: 'value', role: 'internal', x: 485, y: 135, w: 70, h: 70, label: '$y_{i+1}$' },
        { id: 'gi-ydots2', kind: 'value', role: 'internal', x: 595, y: 135, w: 70, h: 70, label: '⋯' },
        { id: 'gi-yt', kind: 'value', role: 'internal', x: 705, y: 135, w: 70, h: 70, label: '$y_t$' },
      ],
      arrows: [{ id: 'gi-reseed', from: 'gi-shat', to: 'gi-yi1', label: '$G(\\hat s_i)$', flow: true }],
    },

    // ── the single hop that a PRG challenge decides ──────────────────────────
    {
      id: 'l-hop',
      name: 'One hop',
      entities: [
        { id: 'hop-shat', kind: 'value', role: 'input', x: 40, y: 214, w: 76, h: 76, label: '$\\hat s_{i-1}$' },
        { id: 'hop-g', kind: 'box', role: 'internal', x: 170, y: 210, w: 104, h: 90, label: 'G' },
        {
          id: 'hop-pair-real',
          kind: 'box',
          role: 'internal',
        ...
        },
        {
          ...
          h: 84,
          label: '(sᵢ,yᵢ)',
          caption: '$\\xleftarrow{\\$}$ uniform',
        },
      ],
      arrows: [
        { id: 'hop-seed', from: 'hop-shat', to: 'hop-g', label: 'uniform seed', flow: true },
        { id: 'hop-out', from: 'hop-g', to: 'hop-pair-real', label: '$(s_i, y_i)$', flow: true },
        { id: 'hop-diff', from: 'hop-pair-real', to: 'hop-pair-rand', label: 'the only difference', flow: false },
      ],
    },

    // ── the reduction that bounds it ─────────────────────────────────────────
    {
      id: 'l-reduction',
      name: 'Reduction Bᵢ',
      entities: [
        ...
        },
        {
          ...
          w: 584,
          h: 404,
          label: 'Distinguisher Bᵢ',
          caption: 'simulates $G_{i-1}$ or $G_i$',
        },
        {
          id: 'assembler',
          kind: 'box',
          ...
          w: 506,
          h: 96,
          label: 'assemble keystream',
          caption: '$y_{1..i-1}$ random,  $y_i = y^*$,  tail chained from $s^*$',
        },
        {
          id: 'adv-d',
          kind: 'box',
          ...
          w: 320,
          h: 124,
          label: 'Keystream Distinguisher D',
          caption: 'outputs one bit',
        },
      ],
      arrows: [
        { id: 'red-w', from: 'prg-challenger', to: 'assembler', label: '$w = (s^*, y^*)$', flow: true },
        {
          id: 'red-keystream',
          from: 'assembler',
          to: 'adv-d',
          label: 'keystream $y_1 \\ldots y_t$',
          flow: true,
          curve: 30,
        },
        { id: 'red-bit', from: 'adv-d', to: 'prg-challenger', label: "$D$'s bit $= B_i$'s guess", flow: true, curve: 90 },
      ],
    },
    ...
    // ── the ideal endpoint ───────────────────────────────────────────────────
    {
      ...
      name: 'Game Gₜ',
      entities: [
        { id: 'gt-banner', kind: 'box', role: 'input', x: 300, y: 30, w: 280, h: 40, label: 'Game  Gₜ' },
        { id: 'gt-y1', kind: 'value', role: 'input', x: 57, y: 118, w: 76, h: 76, label: '$y_1$' },
        { id: 'gt-y2', kind: 'value', role: 'input', x: 187, y: 118, w: 76, h: 76, label: '$y_2$' },
        { id: 'gt-y3', kind: 'value', role: 'input', x: 317, y: 118, w: 76, h: 76, label: '$y_3$' },
        { id: 'gt-y4', kind: 'value', role: 'input', x: 447, y: 118, w: 76, h: 76, label: '$y_4$' },
        { id: 'gt-ydots', kind: 'value', role: 'input', x: 577, y: 118, w: 76, h: 76, label: '⋯' },
        { id: 'gt-yt', kind: 'value', role: 'input', x: 707, y: 118, w: 76, h: 76, label: '$y_t$' },
        {
          id: 'gt-result',
          kind: 'box',
          role: 'reduction',
          ...
          h: 96,
          label: 'Result',
          caption: '$\\mathsf{Adv}_{\\mathrm{cipher}} \\le t \\cdot \\mathsf{Adv}_{\\mathrm{prg}} = \\mathsf{negl}(n)$',
        },
      ],
    },
  ],
  ...
  steps: [
...

    {
      ...
      layer: 'l-ladder',
      reveal: {
        entities: ['lad-g0', 'lad-g1', 'lad-g2', 'lad-gdots', 'lad-gt'],
        arrows: ['lad-h1', 'lad-h2', 'lad-h3', 'lad-h4'],
      },
...

    {
      id: 'seq-telescope',
      layer: 'l-ladder',
      // Back to the ladder from step 3, now with the summed span drawn over it.
      reveal: '*',
